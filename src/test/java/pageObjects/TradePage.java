...
//  public WebElement buySellIndicator;
    ...
    public TradePage makeTrades (String stock, DataTable dt, int numberOfTrades) throws IOException {
    ...
    public TradePage makeTradesForDifferentStocks (DataTable dt) throws IOException {
        List<List<String>> list = dt.asLists(String.class);
        try {
